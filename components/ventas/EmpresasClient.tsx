  ...
  return (
    <div className="flex flex-col h-full">
      ...
      <div className="flex-1 overflow-y-auto px-3 md:px-6 py-4 md:py-5 space-y-4 md:space-y-6 bg-white dark:bg-[#1e2535]">
        ...
        {/* AI Description */}
        {company.description && (
          <Section title="Perfil IA de la empresa">
            <div className="bg-violet-50 dark:bg-violet-900/20 rounded-lg md:rounded-xl p-2 md:p-3 border border-violet-100 dark:border-violet-500/20">
              <div className="flex items-center gap-1.5 mb-1.5">
                ...
                <span className="text-[10px] font-semibold text-violet-500 dark:text-violet-400">Generado por Agente IA</span>
              </div>
              <p className="text-xs md:text-sm text-violet-800 dark:text-violet-200 leading-relaxed whitespace-pre-wrap">{company.description}</p>
            </div>
          </Section>
        )}
