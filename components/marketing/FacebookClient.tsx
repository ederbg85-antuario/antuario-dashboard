        ...
        <>
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 md:gap-4">
            ...
            <div className="rounded-3xl p-4 md:p-5 bg-white dark:bg-[#1e2535]" style={CARD_S}>
              ...
              <p className="text-[10px] mt-1.5 text-slate-400 dark:text-slate-500">Total del período</p>
            </div>
          </div>
          ...
          <div className="grid grid-cols-2 lg:grid-cols-3 gap-3 md:gap-4">
            <div className="rounded-3xl p-4 md:p-5 bg-white dark:bg-[#1e2535]" style={CARD_S}>
              <p className="text-[10px] font-bold text-slate-400 dark:text-slate-500 uppercase tracking-widest mb-2">Me gusta (página)</p>
              <p className="text-xl font-bold tabular-nums text-slate-900 dark:text-white">{fmtN(m.likes)}</p>
            </div>
            <div className="rounded-3xl p-4 md:p-5 bg-white dark:bg-[#1e2535]" style={CARD_S}>
              <p className="text-[10px] font-bold text-slate-400 dark:text-slate-500 uppercase tracking-widest mb-2">Usuarios comprometidos</p>
              <p className="text-xl font-bold tabular-nums text-slate-900 dark:text-white">{fmtN(m.engaged)}</p>
            </div>
            <div className="rounded-3xl p-4 md:p-5 bg-white dark:bg-[#1e2535]" style={CARD_S}>
              <p className="text-[10px] font-bold text-slate-400 dark:text-slate-500 uppercase tracking-widest mb-2">Publicaciones</p>
              <p className="text-xl font-bold tabular-nums text-slate-900 dark:text-white">{fmtN(m.posts)}</p>
            </div>
          </div>
          ...
          {trendByDate.length > 0 && (
            <div className="bg-white dark:bg-[#161b27] rounded-3xl p-5 md:p-6" style={CARD_S}>
              <h3 className="text-[13px] font-semibold text-slate-800 dark:text-slate-100 mb-1">Alcance diario</h3>
              <p className="text-[11px] text-slate-400 dark:text-slate-500 mb-4">Personas alcanzadas por día</p>
              <ResponsiveContainer width="100%" height={200}>
                <AreaChart data={trendByDate}>
                  ...
                  <Tooltip
                    ...
                    formatter={(v: any) => [fmtN(v as number), 'Alcance']}
                    // eslint-disable-next-line @typescript-eslint/no-explicit-any
