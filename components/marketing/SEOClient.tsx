  ...
  return (
    <div className={PAGE_WRAP}>
      ...
      <div className="bg-white rounded-3xl p-6" style={CARD_S}>
        <p className="text-[10px] font-bold tracking-[0.14em] uppercase text-slate-400 mb-6">Clics vs Impresiones — últimos 6 meses</p>
      ...
      <div className="grid grid-cols-2 gap-4">
        <div className="bg-white rounded-3xl p-6" style={CARD_S}>
          <p className="text-[10px] font-bold tracking-[0.14em] uppercase text-slate-400 mb-4">Top 20 Keywords por clics</p>
        ...
        <div className="bg-white rounded-3xl p-6 border border-amber-100" style={CARD_S}>
          <div className="flex items-center gap-2 mb-3">
            <span className="text-amber-500 text-lg">⚡</span>
            <p className="text-[10px] font-bold tracking-[0.14em] uppercase text-slate-400">Oportunidades de crecimiento</p>
          </div>
          <p className="text-xs text-slate-500 mb-4 leading-relaxed">Keywords con muchas impresiones pero CTR bajo — mejorar su título puede generar clics sin costo extra.</p>
              ...
              {opportunities.map((op, i) => (
                <div key={i} className="flex items-center justify-between p-3 bg-amber-50 rounded-2xl">
                  <div className="min-w-0 flex-1">
                    <p className="text-sm font-semibold text-slate-700 truncate">{op.kw}</p>
...
function NoData({ label, lastSync }: { label: string; lastSync: string | null }) {
  return (
    <div className="flex flex-col items-center justify-center py-32 text-center px-8">
      <div className="w-14 h-14 rounded-3xl bg-slate-100 flex items-center justify-center mb-5">
