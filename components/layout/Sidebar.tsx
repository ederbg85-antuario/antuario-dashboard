...
// ─── Icons ────────────────────────────────────────────────────────────────────
const I = {
  calendar:   <svg className="w-3.5 h-3.5" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.8} d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z" /></svg>,
  ...
  prospecting:<svg className="w-3.5 h-3.5" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.8} d="M12 3v2m0 14v2m9-9h-2M5 12H3m15.36 6.36l-1.42-1.42M6.06 6.06L4.64 4.64m12.72 0l-1.42 1.42M6.06 17.94l-1.42 1.42M15 12a3 3 0 11-6 0 3 3 0 016 0z" /></svg>,
  ...
  mail:       <svg className="w-3.5 h-3.5" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.8} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" /></svg>,
...
const NAV: NavSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { href: '/marketing/meta',      label: 'Meta Ads',         icon: I.facebook,  badge: 'Meta', badgeVariant: 'data', iconColor: 'bg-blue-600'    },
      { href: '/marketing/facebook',  label: 'Facebook',         icon: I.facebook,  badge: 'FB',   badgeVariant: 'data', iconColor: 'bg-blue-500'    },
      { href: '/marketing/instagram', label: 'Instagram',        icon: I.instagram, badge: 'IG',   badgeVariant: 'data', iconColor: 'bg-pink-500'    },
    ],
    comingSoon: [
