// ============================================================
// app/(dashboard)/marketing/instagram/page.tsx
// ============================================================
import { createServerClient } from '@supabase/ssr'
import { cookies } from 'next/headers'
import { redirect } from 'next/navigation'
import InstagramClient from '@/components/marketing/InstagramClient'
...
export default async function InstagramPage() {
  ...
  const [
    ...
    supabase.from('marketing_connections')
      ...
      .eq('organization_id', orgId).eq('source', 'instagram')
    ...
    supabase.from('marketing_daily_summary')
      ...
      .eq('organization_id', orgId).eq('source', 'instagram')
      .gte('date', from).lte('date', to)
      .in('metric_key', ['reach', 'impressions', 'profile_views'])
