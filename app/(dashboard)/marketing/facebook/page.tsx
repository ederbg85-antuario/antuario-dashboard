// ============================================================
// app/(dashboard)/marketing/facebook/page.tsx
// ============================================================
import { createServerClient } from '@supabase/ssr'
import { cookies } from 'next/headers'
import { redirect } from 'next/navigation'
import FacebookClient from '@/components/marketing/FacebookClient'
...
export default async function FacebookPage() {
  ...
  const [
    ...
    supabase.from('marketing_connections')
      ...
      .eq('organization_id', orgId).eq('source', 'facebook')
    ...
    supabase.from('marketing_daily_summary')
      ...
      .eq('organization_id', orgId).eq('source', 'facebook')
      .gte('date', from).lte('date', to)
      .in('metric_key', ['reach', 'impressions', 'engaged_users'])
